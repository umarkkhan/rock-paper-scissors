...
addBoxButton1.addEventListener('click',() =>{
    ...
    //  function Rfinal(){
    //     if( users.textContent> comps.textContent){
    //        document.getElementById('next').innerHTML =` <div class="finalstuff">
    ...
    //    <div class="finalstuff">
    //        <div id="aa1">BETTER LUCK NEXT TIME!!</div>
    //        <div id="aa2">YOU LOST THE GAME</div>
    //        <div id="aa3"><a href="index.html"><button id="addBox" >Play Again</button></a></div>
    //    </div>`
    //     }
    //     }
